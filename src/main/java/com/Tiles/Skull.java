...
public class Skull {
    ...
    public void draw(Graphics g, ImageObserver observer) {
        ...
        g.drawImage(image, (pos.x * CreateMap.TILE_SIZE-(CreateMap.TILE_SIZE/2))+CreateMap.xOffset, (pos.y * CreateMap.TILE_SIZE - (CreateMap.TILE_SIZE/2))+CreateMap.yOffset, observer);
    }
